...
<html>
    <head>
        ...
        <?php $app_url = env('APP_ENV') == 'local' ? 'https://dev.ushift.com/' : url('/');?>
        <link href="{{$app_url}}assets/css/email_fonts.css" rel="stylesheet">
        <!--[if !mso]> -->
        <link href="{{$app_url}}assets/css/email_fonts.css" rel="stylesheet">
        <!--<![endif]-->
                    ...
                    <table width="600" cellpadding="0" cellspacing="0">
                        ...
                        {{-- <tr>
                            <td style="{{ $style['email-masthead'] }}">
                                <a style="{{ $custom_style['font-normal'] }} {{ $style['email-masthead_name'] }}" href="{{ url('/') }}" target="_blank">
